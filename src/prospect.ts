...
const KNOWN_CHAINS =
  /\b(specsavers|vision express|optical express|boots opticians?|scrivens opticians?|hakim group|vets ?4 ?pets|pets at home|medivet|cvs vets|ivc evidensia|independent vetcare|vetpartners|companion care|goddard veterinary|white ?cross vets|my ?dentist|portman dental|rodericks dental|dental partners|together dental|colosseum dental|damira dental|nuffield health|spire healthcare|spire hospital|hca healthcare|circle health|practice plus|create fertility|london women'?s clinic|care fertility|fertility partnership|bourn hall|haart|spicerhaart|connells|william h ?brown|bairstow eves|your ?move|reeds rains|foxtons|savills|knight frank|purplebricks|winkworth|chancellors|belvoir|martin ?& ?co lettings|howden|ardonagh|towergate|hastings direct|a ?-? ?plan insurance|swinton insurance|simply business|john charcol|mortgage advice bureau|fluent money|taxassist|grant thornton|mazars|pimlico plumbers|dyno-?rod|british gas|homeserve|pirtek|mr\.? ?electric)\b/i;
